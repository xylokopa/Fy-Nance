# Fy-Nance_15.py 05-06-2026 Projekt Ticker-Oszillograph R.W_Guest_Nr_178854
import numpy as np
import pandas as pd
...
plt.subplots_adjust(left=0.20, bottom=0.24, right=0.97)
...
ax1_btn24 = plt.axes([0.885, 0.010, 0.04, 0.04])
# --- Belegung 2-SCHALTFELD ---
wal_btn21 = Button(ax1_btn21, 'B11', color='#c1c1c1')
...
ax1_btn34 = plt.axes([0.930, 0.010, 0.04, 0.04])
# --- Belegung 3-SCHALTFELD ---
wal_btn31 = Button(ax1_btn31, 'C11', color='#fafbfc')
...
btn_online = Button(ax1_online, 'ONLINE' if val_online else 'OFFLINE', color='aqua' if val_online else 'teal')
...
# ------------------------------------------------------------------------------
#     09   Vorbereitung Ticker-Klavier am linken Rand 
# ------------------------------------------------------------------------------
ticker_klavier = []
